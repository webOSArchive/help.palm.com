...
var s_account="palmus,palmglobal,palmall"
...
s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,doc,pdf,xls,prc,dmg,sit,pdb,cab,msi,m4v,mp4,jnlp"
s.linkInternalFilters="javascript:,palm.com,palmone.r3h.net,www.palmthing.com,palmthing.com,secure.opinionlab.com,palmcentro"
...
function s_doPlugins(s) {
	...
	if (s.getQueryParam('sssdmh')) {
		s.eVar32=s.getQueryParam('sssdmh');
